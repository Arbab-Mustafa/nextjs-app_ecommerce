...
var productImages = [
  "/products/laptop/redmibook-15/productImages/1.jpeg",
  "/products/laptop/redmibook-15/productImages/2.jpeg",
  "/products/laptop/redmibook-15/productImages/3.jpeg",
  "/products/laptop/redmibook-15/productImages/4.jpeg",
  "/products/laptop/redmibook-15/productImages/5.jpeg",
  "/products/laptop/redmibook-15/productImages/6.jpeg",
];

var pageImages = [
  "/products/laptop/redmibook-15/pageImages/1.jpeg",
  "/products/laptop/redmibook-15/pageImages/2.jpeg",
  "/products/laptop/redmibook-15/pageImages/3.jpeg",
  "/products/laptop/redmibook-15/pageImages/4.jpeg",
  "/products/laptop/redmibook-15/pageImages/5.jpeg",
];
...
const Redmibook15Pro = () => {
      ...
      <div className="my-2">
        <div className="mx-4">
          ...
          <div className="text-sm font-light mt-2">
            RedmiBook 15 Super Start Work Who is it meant for? As the name
            indicates, the RedmiBook is the perfect laptop for the
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="RedmiBook 15" />
