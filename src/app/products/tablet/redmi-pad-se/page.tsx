...
var productImages = [
  "/products/tablet/redmi-pad-se/productImages/1.jpeg",
  "/products/tablet/redmi-pad-se/productImages/2.jpeg",
  "/products/tablet/redmi-pad-se/productImages/3.jpeg",
  "/products/tablet/redmi-pad-se/productImages/4.jpeg",
  "/products/tablet/redmi-pad-se/productImages/5.jpeg",
  "/products/tablet/redmi-pad-se/productImages/6.jpeg",
];

var pageImages = [
  "/products/tablet/redmi-pad-se/pageImages/1.jpeg",
  "/products/tablet/redmi-pad-se/pageImages/2.jpeg",
  "/products/tablet/redmi-pad-se/pageImages/3.jpeg",
  "/products/tablet/redmi-pad-se/pageImages/4.jpeg",
  "/products/tablet/redmi-pad-se/pageImages/5.jpeg",
];
...
const RedmiPadSE = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi Pad SE" />
