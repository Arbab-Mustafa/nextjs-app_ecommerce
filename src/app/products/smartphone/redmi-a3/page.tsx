...
var productImages = [
  "/products/smartphone/redmi-a3/productImages/1.jpeg",
  "/products/smartphone/redmi-a3/productImages/2.jpeg",
  "/products/smartphone/redmi-a3/productImages/3.jpeg",
  "/products/smartphone/redmi-a3/productImages/4.jpeg",
  "/products/smartphone/redmi-a3/productImages/5.jpeg",
  "/products/smartphone/redmi-a3/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/redmi-a3/pageImages/1.jpeg",
  "/products/smartphone/redmi-a3/pageImages/2.jpeg",
  "/products/smartphone/redmi-a3/pageImages/3.jpeg",
  "/products/smartphone/redmi-a3/pageImages/4.jpeg",
  "/products/smartphone/redmi-a3/pageImages/5.jpeg",
];
...
const colorNames = ["Lake Blue", "Midnight Black", "Olive Green"];
const hexCodes = ["#a3c5f3", "#0e0f10", "#475d50"];
const storageOptions = ["6 GB + 128 GB", "4 GB + 128 GB", "3 GB + 64 GB"];
...
const RedmiA3Page = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi A3" />
