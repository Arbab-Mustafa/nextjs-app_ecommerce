...
var productImages = [
  "/products/smartphone/redmi-note-13-pro/productImages/1.jpeg",
  "/products/smartphone/redmi-note-13-pro/productImages/2.jpeg",
  "/products/smartphone/redmi-note-13-pro/productImages/3.jpeg",
  "/products/smartphone/redmi-note-13-pro/productImages/4.jpeg",
  "/products/smartphone/redmi-note-13-pro/productImages/5.jpeg",
  "/products/smartphone/redmi-note-13-pro/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/redmi-note-13-pro/pageImages/1.jpeg",
  "/products/smartphone/redmi-note-13-pro/pageImages/2.jpeg",
  "/products/smartphone/redmi-note-13-pro/pageImages/3.jpeg",
  "/products/smartphone/redmi-note-13-pro/pageImages/4.jpeg",
  "/products/smartphone/redmi-note-13-pro/pageImages/5.jpeg",
];
...
const colorNames = ["Arctic White", "Midnight Black", "Coral Purple"];
const hexCodes = ["#e0e0e3", "#000000", "#0e0f10"];
const storageOptions = ["12 GB + 512 GB", "12GB + 256 GB", "8 GB + 256 GB"];

const productId = 5;

const RedmiNote13ProPage = () => {
      ...
      <div className="my-2">
        <div className="mx-4">
          ...
          <div className="text-sm font-light mt-2">
            ...
            what makes a Note. With Redmi Note 13 Pro enjoy a captivating
            ...
            “cheese”. With voice shutter on Redmi Note 13 Pro, all you need to do
            ...
            battery life. Based on Android 13 and MIUI 14, Redmi Note 13 Pro
            ensures an intuitive UI experience optimised for your daily
            needs.With IP54 rating your Redmi Note 13 Pro will always be
            ...
            Powering Redmi Note 13 Pro is an all-day 5000mAh battery with support
    ...
    "MIUI 14": (
      <div className="mx-4">
        ...
        <div className="text-sm font-light mt-2">
          ...
          optimized for the Redmi Note 13 Pro Limited Edition.
        </div>
      </div>
    ),
  };
...
export default RedmiNote13ProPage;