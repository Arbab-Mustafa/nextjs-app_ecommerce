...
var productImages = [
  "/products/smartphone/redmi-note-13-pro-plus/productImages/1.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/productImages/2.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/productImages/3.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/productImages/4.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/productImages/5.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/redmi-note-13-pro-plus/pageImages/1.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/pageImages/2.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/pageImages/3.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/pageImages/4.jpeg",
  "/products/smartphone/redmi-note-13-pro-plus/pageImages/5.jpeg",
];
...
const colorNames = ["Fusion White", "Fusion Black", "Fusion Purple"];
const hexCodes = ["#FFFFFF", "#000000", "#cacae2"];
const storageOptions = ["12 GB + 512 GB", "12GB + 256 GB", "8 GB + 256 GB"];

const productId = 4;

const RedmiNote13ProPlusPage = () => {
      ...
      <div className="my-2">
        <div className="mx-4">
          ...
          <div className="text-sm font-light mt-2">
            ...
            what makes a Note. With Redmi Note 13 Pro Plus enjoy a captivating
            ...
            “cheese”. With voice shutter on Redmi Note 13 Pro Plus, all you need to do
            ...
            battery life. Based on Android 13 and MIUI 14, Redmi Note 13 Pro Plus
            ensures an intuitive UI experience optimised for your daily
            needs.With IP54 rating your Redmi Note 13 Pro Plus will always be
            ...
            Powering Redmi Note 13 Pro Plus is an all-day 5000mAh battery with support
    ...
    "MIUI 14": (
      <div className="mx-4">
        ...
        <div className="text-sm font-light mt-2">
          ...
          optimized for the Redmi Note 13 Pro Plus Limited Edition.
        </div>
      </div>
    ),
  };
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi Note 13 Pro+" />
...
export default RedmiNote13ProPlusPage;
