...
var productImages = [
  "/products/smartphone/xiaomi-14/productImages/1.jpeg",
  "/products/smartphone/xiaomi-14/productImages/2.jpeg",
  "/products/smartphone/xiaomi-14/productImages/3.jpeg",
  "/products/smartphone/xiaomi-14/productImages/4.jpeg",
  "/products/smartphone/xiaomi-14/productImages/5.jpeg",
  "/products/smartphone/xiaomi-14/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/xiaomi-14/pageImages/1.jpeg",
  "/products/smartphone/xiaomi-14/pageImages/2.jpeg",
  "/products/smartphone/xiaomi-14/pageImages/3.jpeg",
  "/products/smartphone/xiaomi-14/pageImages/4.jpeg",
  "/products/smartphone/xiaomi-14/pageImages/5.jpeg",
];
...
const colorNames = ["White", "Black", "Jade Green"];
...
const Xiaomi14Page = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Xiaomi 14" />
