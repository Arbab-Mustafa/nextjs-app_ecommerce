...
var productImages = [
  "/products/smartphone/redmi-note-13-5g/productImages/1.jpeg",
  "/products/smartphone/redmi-note-13-5g/productImages/2.jpeg",
  "/products/smartphone/redmi-note-13-5g/productImages/3.jpeg",
  "/products/smartphone/redmi-note-13-5g/productImages/4.jpeg",
  "/products/smartphone/redmi-note-13-5g/productImages/5.jpeg",
  "/products/smartphone/redmi-note-13-5g/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/redmi-note-13-5g/pageImages/1.jpeg",
  "/products/smartphone/redmi-note-13-5g/pageImages/2.jpeg",
  "/products/smartphone/redmi-note-13-5g/pageImages/3.jpeg",
  "/products/smartphone/redmi-note-13-5g/pageImages/4.jpeg",
  "/products/smartphone/redmi-note-13-5g/pageImages/5.jpeg",
];
...
const colorNames = ["Arctic White", "Chromatic Purple", "Stealth Black"];
const hexCodes = ["#e0e0e3", "#bdc0e1", "#2b2a31"];
const storageOptions = ["12 GB + 256 GB", "8 GB + 256 GB", "6 GB + 128 GB"];

const productId = 9;

const RedmiNote135gPage = () => {
      ...
      <div className="my-2">
        <div className="mx-4">
          ...
          <div className="text-sm font-light mt-2">
            ...
            what makes a Note. With Redmi Note 13 5G, enjoy a captivating
            ...
            “cheese”. With voice shutter on Redmi Note 13 5G, all you need to do
            ...
            battery life. Based on Android 13 and MIUI 14, Redmi Note 13 5G
            ensures an intuitive UI experience optimised for your daily
            needs.With IP54 rating your Redmi Note 13 5G will always be
            ...
            Powering Redmi Note 13 5G is an all-day 5000mAh battery with support
    ...
    "MIUI 14": (
      <div className="mx-4">
        ...
        <div className="text-sm font-light mt-2">
          ...
          optimized for the Redmi Note 13 5G Limited Edition.
        </div>
      </div>
    ),
  };
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi Note 13 5G" />
...
export default RedmiNote135gPage;
