...
var productImages = [
  "/products/smartphone/redmi-13c-5g/productImages/1.jpeg",
  "/products/smartphone/redmi-13c-5g/productImages/2.jpeg",
  "/products/smartphone/redmi-13c-5g/productImages/3.jpeg",
  "/products/smartphone/redmi-13c-5g/productImages/4.jpeg",
  "/products/smartphone/redmi-13c-5g/productImages/5.jpeg",
  "/products/smartphone/redmi-13c-5g/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/redmi-13c-5g/pageImages/1.jpeg",
  "/products/smartphone/redmi-13c-5g/pageImages/2.jpeg",
  "/products/smartphone/redmi-13c-5g/pageImages/3.jpeg"
];
...
const colorNames = ["Startrail Green", "Starlight Black", "Startrail Silver"];
const hexCodes = ["#cfd4c4", "#171718", "#cbcbdd"];
const storageOptions = ["8 GB + 256 GB", "6 GB + 128 GB", "4 GB + 128 GB"];

const productId = 10;

const Redmi13C5GPage = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi 13C 5G" />
