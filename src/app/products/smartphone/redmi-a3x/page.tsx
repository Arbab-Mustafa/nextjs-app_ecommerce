...
var productImages = [
  "/products/smartphone/redmi-a3x/productImages/1.jpeg",
  "/products/smartphone/redmi-a3x/productImages/2.jpeg",
  "/products/smartphone/redmi-a3x/productImages/3.jpeg",
  "/products/smartphone/redmi-a3x/productImages/4.jpeg",
  "/products/smartphone/redmi-a3x/productImages/5.jpeg",
  "/products/smartphone/redmi-a3x/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/redmi-a3x/pageImages/1.jpeg",
  "/products/smartphone/redmi-a3x/pageImages/2.jpeg",
  "/products/smartphone/redmi-a3x/pageImages/3.jpeg",
  "/products/smartphone/redmi-a3x/pageImages/4.jpeg",
  "/products/smartphone/redmi-a3x/pageImages/5.jpeg",
];
...
const colorNames = ["Starry White", "Midnight Black", "Olive Green"];
const hexCodes = ["#a3c5f3", "#0e0f10", "#475d50"];
const storageOptions = ["4 GB + 128 GB", "3 GB + 64 GB"];
...
const RedmiA3xPage = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi A3X" />
