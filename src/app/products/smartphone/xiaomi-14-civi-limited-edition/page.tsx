...
var productImages = [
  "/products/smartphone/xiaomi-14-civi-limited-edition/productImages/1.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/productImages/2.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/productImages/3.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/productImages/4.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/productImages/5.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/productImages/6.webp",
];

var pageImages = [
  "/products/smartphone/xiaomi-14-civi-limited-edition/pageImages/2.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/pageImages/3.webp",
  "/products/smartphone/xiaomi-14-civi-limited-edition/pageImages/4.webp",
];
...
const colorNames = ["Hot Pink", "Panda White", "Aqua Blue"];
const hexCodes = ["#FF007F", "#FFFFFF", "#00FFFF"];
const storageOptions = ["12 GB + 512 GB"];

const productId = 1;

const Xiaomi14CiviLimitedEditionPage = () => {
      ...
      <div className="my-2">
        <div className="mx-4">
          ...
          <div className="text-sm font-light mt-2">
            The Xiaomi 14 CIVI Limited Edition is a limited edition smartphone
            from Xiaomi. It is a limited edition smartphone that is available in
            three colors. The phone has a 6.55-inch AMOLED display with a
            resolution of 1080 x 2400 pixels. The phone is powered by a Qualcomm
            Snapdragon 778G processor and comes with 12GB of RAM and 512GB of
            internal storage. The phone runs on MIUI 14 based on Android 12 and
            has a 4500mAh battery with support for 33W fast charging. The phone
            has a triple camera setup on the back with a 108MP primary sensor,
            an 8MP ultra-wide sensor, and a 5MP macro sensor. The phone has a
            20MP front camera for selfies. The phone has an in-display
            fingerprint sensor and comes with support for 5G, Wi-Fi 6, Bluetooth
            5.2, and NFC.
          </div>
        </div>
    ...
    "MIUI 14": (
      <div className="mx-4">
        ...
        <div className="text-sm font-light mt-2">
          ...
          optimized for the Xiaomi 14 CIVI Limited Edition.
        </div>
      </div>
    ),
  };
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Xiaomi 14 CIVI Limited Edition" />
...
export default Xiaomi14CiviLimitedEditionPage;
