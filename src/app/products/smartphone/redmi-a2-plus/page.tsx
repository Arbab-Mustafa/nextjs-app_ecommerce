...
var productImages = [
  "/products/smartphone/redmi-a2-plus/productImages/1.jpeg",
  "/products/smartphone/redmi-a2-plus/productImages/2.jpeg",
  "/products/smartphone/redmi-a2-plus/productImages/3.jpeg",
  "/products/smartphone/redmi-a2-plus/productImages/4.jpeg"
];

var pageImages = [
  "/products/smartphone/redmi-a2-plus/pageImages/1.jpeg",
  "/products/smartphone/redmi-a2-plus/pageImages/2.jpeg",
  "/products/smartphone/redmi-a2-plus/pageImages/3.jpeg",
  "/products/smartphone/redmi-a2-plus/pageImages/4.jpeg",
  "/products/smartphone/redmi-a2-plus/pageImages/5.jpeg",
];
...
const colorNames = ["Aqua Blue", "Classic Black", "Sea Green"];
const hexCodes = ["#a8c7db", "#3b3e42", "#c2dbc9"];
const storageOptions = ["4 GB + 128 GB", "4 GB + 64 GB"];

const productId = 12;

const RedmiA2PlusPage = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi A2 Plus" />
...
export default RedmiA2PlusPage;
