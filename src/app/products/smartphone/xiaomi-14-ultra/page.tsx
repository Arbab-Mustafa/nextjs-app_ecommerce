...
var productImages = [
  "/products/smartphone/xiaomi-14-ultra/productImages/1.jpeg",
  "/products/smartphone/xiaomi-14-ultra/productImages/2.jpeg",
  "/products/smartphone/xiaomi-14-ultra/productImages/3.jpeg",
  "/products/smartphone/xiaomi-14-ultra/productImages/4.jpeg",
  "/products/smartphone/xiaomi-14-ultra/productImages/5.jpeg",
  "/products/smartphone/xiaomi-14-ultra/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartphone/xiaomi-14-ultra/pageImages/1.jpeg",
  "/products/smartphone/xiaomi-14-ultra/pageImages/2.jpeg",
  "/products/smartphone/xiaomi-14-ultra/pageImages/3.jpeg",
  "/products/smartphone/xiaomi-14-ultra/pageImages/4.jpeg",
  "/products/smartphone/xiaomi-14-ultra/pageImages/5.jpeg",
];
...
const colorNames = ["White", "Black"];
const hexCodes = ["#FFFFFF", "#000000"];
const storageOptions = ["16 GB + 512 GB"];

const productId = 2;

const Xiaomi14UltraPage = () => {
      ...
      <div className="my-2">
        <div className="mx-4">
          ...
          <div className="text-sm font-light mt-2">
            ...
            what makes a Note. With Xiaomi 14 Ultra enjoy a captivating
            ...
            “cheese”. With voice shutter on Xiaomi 14 Ultra, all you need to do
            ...
            battery life. Based on Android 13 and MIUI 14, Xiaomi 14 Ultra
            ensures an intuitive UI experience optimised for your daily
            needs.With IP54 rating your Xiaomi 14 Ultra will always be
            ...
            Powering Xiaomi 14 Ultra is an all-day 5000mAh battery with support
    ...
    "MIUI 14": (
      <div className="mx-4">
        ...
        <div className="text-sm font-light mt-2">
          ...
          optimized for the Xiaomi 14 Ultra Limited Edition.
        </div>
      </div>
    ),
  };
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Xiaomi 14 Ultra" />
...
export default Xiaomi14UltraPage;
