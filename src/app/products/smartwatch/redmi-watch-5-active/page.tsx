...
var productImages = [
  "/products/smartwatch/redmi-watch-5-active/productImages/1.jpeg",
  "/products/smartwatch/redmi-watch-5-active/productImages/2.jpeg",
  "/products/smartwatch/redmi-watch-5-active/productImages/3.jpeg",
  "/products/smartwatch/redmi-watch-5-active/productImages/4.jpeg",
  "/products/smartwatch/redmi-watch-5-active/productImages/5.jpeg",
  "/products/smartwatch/redmi-watch-5-active/productImages/6.jpeg",
];

var pageImages = [
  "/products/smartwatch/redmi-watch-5-active/pageImages/1.jpeg",
  "/products/smartwatch/redmi-watch-5-active/pageImages/2.jpeg",
  "/products/smartwatch/redmi-watch-5-active/pageImages/3.jpeg",
  "/products/smartwatch/redmi-watch-5-active/pageImages/4.jpeg",
  "/products/smartwatch/redmi-watch-5-active/pageImages/5.jpeg",
];
...
const RedmiWatch5Active = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi Watch 5 Active" />
...
export default RedmiWatch5Active;
