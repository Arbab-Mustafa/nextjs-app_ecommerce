...
var productImages = [
  "/products/smartwatch/redmi-watch-5-lite/productImages/1.jpeg",
  "/products/smartwatch/redmi-watch-5-lite/productImages/2.jpeg",
];

var pageImages = [
  "/products/smartwatch/redmi-watch-5-lite/pageImages/1.jpeg",
  "/products/smartwatch/redmi-watch-5-lite/pageImages/2.jpeg",
  "/products/smartwatch/redmi-watch-5-lite/pageImages/3.jpeg",
  "/products/smartwatch/redmi-watch-5-lite/pageImages/4.jpeg",
  "/products/smartwatch/redmi-watch-5-lite/pageImages/5.jpeg",
];
...
const RedmiWatch5Lite = () => {
  ...
  return isLoading ? (
    ...
    <div className="bg-white">
      <ProductPageHeader product="Redmi Watch 5 Lite" />
...
export default RedmiWatch5Lite;
